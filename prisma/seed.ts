...
async function main() {
  ...
  try {
    ...
    const unicorns = [
      ...
      ["BlackBerry (RIM)", "Waterloo-Kitchener-C", "Mobile", "Mike Lazaridis, Douglas Fregin", "1990s", 130.0, "Public", false, null],
      ...
      ["OpenText", "Waterloo-Kitchener-C", "Software", "Tim Bray, Gaston Gonnet", "2000s", 18.0, "Public", false, null],
      ["AbCellera Biologics", "Vancouver", "Biotech", "Carl Hansen", "2020s", 15.7, "Public (declined)", false, null],
      ["Xanadu", "Toronto", "Quantum", "Christian Weedbrook", "2020s", 13.3, "Private", false, null],
      ["ATI Technologies", "Toronto", "Semiconductors", "Lee Ka Lau et al.", "1990s", 12.6, "Acquired", false, "US"],
      ["Hut 8 Corp", "Toronto", "Web3", "Marc van der Chijs", "2020s", 11.6, "Public", false, null],
      ...
      ["ApplyBoard", "Waterloo-Kitchener-C", "Edtech", "Martin, Meti & Massi Basiri", "2020s", 4.0, "Private", false, null],
      ...
      ["Mitel", "Ottawa-Gatineau", "Telecom", "Terry Matthews, Michael Cowpland", "1980s", 5.5, "Private (post-Ch. 11)", false, null],
      ...
      ["Magnet Forensics", "Waterloo-Kitchener-C", "Cybersecurity", "Jad Saliba, Adam Belsher", "2020s", 1.9, "Acquired", false, "US"],
      ...
      ["eSentire", "Waterloo-Kitchener-C", "Cybersecurity", "Eldon Sprickerhoff", "2020s", 1.5, "Private", false, null],
      ["Hootsuite", "Vancouver", "Martech", "Ryan Holmes", "2010s", 1.5, "Private", false, null],
      ["Kik", "Waterloo-Kitchener-C", "Social/Web3", "Ted Livingston", "2010s", 1.5, "Defunct/Acquired US", false, "US"],
      ...
      ["Dragonwave", "Ottawa-Gatineau", "Telecom", "Jean-Paul Baric", "2000s", 1.2, "Acquired", false, "European"],
