...
async function main() {
  ...
  try {
    ...
    const unicorns = [
      ...
      ["Tenstorrent", 2016, 10, "Active: age uses current year (2026)", "Toronto", "AI Hardware", 'Ljubisa Bajic', "2020s", 3.8, "Private", false, null],
      ...
      ["Coveo", 2005, 21, "Active: age uses current year (2026)", "Québec City", "AI/Search", 'Laurent Simoneau, Richard Tessier', "2010s", 1.4, "Public", false, null],
