...
export const SHOPIFY_DATA: LineageNode[] = [
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2015,
    description: 'Issue tracking & service for cloud services.',
    relationship: 'Alum Investment',
  },
  {
    id: 'kit',
    name: 'Kit',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2017,
    description: 'Discover, buy & manage developer APIs.',
    relationship: 'Alum Investment',
  },
  {
    id: 'integrate-ai',
    ...
    parent: 'shopify',
    year: 2017,
    description: 'Machine learning tools for developers to apply AI.',
    relationship: 'Alum Investment',
  },
  {
    id: 'hubba',
    ...
    parent: 'shopify',
    year: 2017,
    description: 'Commerce website and community.',
    relationship: 'Alum Investment',
  },
  {
  ...
  {
    id: 'raven-telemetry',
    name: 'Raven Telemetry',
    type: 'company',
    parent: 'shopify',
    year: 2018,
    description: 'Mobile software & AI manufacturing profitability.',
    relationship: 'Alum Investment',
  },
  {
    id: 'convential',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2018,
    description: 'E-commerce loyalty app.',
    relationship: 'Alum Investment',
  },
  {
    id: 'carrot-page',
    ...
    parent: 'shopify',
    year: 2018,
    description: 'On-demand & personalized art.',
    relationship: 'Alum Investment',
  },
  {
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2019,
    description: 'Innovative footwear brand.',
    relationship: 'Alum Investment',
  },
  {
    id: 'float',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2020,
    description: 'Harnesses AI and robotics to accelerate drug discovery.',
    relationship: 'Alum Investment',
  },
  {
    id: 'afterward',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2020,
    description: 'Wippo helps people create and run in-person events.',
    relationship: 'Alum Investment',
  },
  {
    id: 'runway',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2020,
    description: 'Witi is an API tool for developers.',
    relationship: 'Alum Investment',
  },
  {
    id: 'alan',
    ...
    parent: 'shopify',
    year: 2020,
    description: 'Online digital insurance services for business.',
    relationship: 'Alum Investment',
  },
  {
    id: 'wilio-ai',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2021,
    description: 'Online food store delivers a range of goods.',
    relationship: 'Alum Investment',
  },
  {
    id: 'gadget',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2021,
    description: 'Observability for mobile and web, built on OpenTelemetry.',
    relationship: 'Alum Investment',
  },
  {
    id: 'kranial',
    ...
    parent: 'shopify',
    year: 2021,
    description: 'Connect IoT devices through satellites and cellular grids.',
    relationship: 'Alum Investment',
  },
  {
    id: 'plato',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2021,
    description: 'App to track/pay for restaurant repair/maintenance.',
    relationship: 'Alum Investment',
  },
  {
    id: 'disco',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2021,
    description: 'Professional network for startup engineers.',
    relationship: 'Alum Investment',
  },
  {
    id: 'creative-layer',
    ...
    parent: 'shopify',
    year: 2021,
    description: 'Print-on-demand for personalized products.',
    relationship: 'Alum Investment',
  },
  {
    id: 'ipaid',
    ...
    parent: 'shopify',
    year: 2021,
    description: 'Connects brands with influencers to develop social media presence.',
    relationship: 'Alum Investment',
  },
  {
    id: 'primer-ar',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2021,
    description: 'Password manager for storing personal/credit card info.',
    relationship: 'Alum Investment',
    isUnicorn: true,
  },
  {
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2021,
    description: 'Editor converts audio into text for editing.',
    relationship: 'Alum Investment',
  },
  {
    id: 'slamcore',
    ...
    parent: 'shopify',
    year: 2021,
    description: 'Visual positioning algorithms for robots & drones.',
    relationship: 'Alum Investment',
  },
  {
    id: 'gemini-ventures',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2021,
    description: 'Empowers robotics teams to visually debug and train robots.',
    relationship: 'Alum Investment',
  },
  {
    id: 'synthetical',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2021,
    description: 'Generative AI assistant for lawyers.',
    relationship: 'Alum Investment',
  },
  {
    id: 'lili',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2021,
    description: 'Healthcare provider app for booking, billing, analytics, etc.',
    relationship: 'Alum Investment',
  },
  {
    id: 'sim',
    ...
    parent: 'shopify',
    year: 2021,
    description: 'AI platform to automate/sync workflow data.',
    relationship: 'Alum Investment',
  },
  {
    id: 'augment',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2021,
    description: 'API service that bridges distributed data for integration.',
    relationship: 'Alum Investment',
  },
  {
    id: 'anything',
    ...
    parent: 'shopify',
    year: 2021,
    description: 'AI API-ago builder.',
    relationship: 'Alum Investment',
  },
  {
    id: 'realworld',
    ...
    parent: 'shopify',
    year: 2021,
    description: 'Agentless home-buying platform.',
    relationship: 'Alum Investment',
  },
  {
    id: 'manifest-labs',
    ...
    parent: 'shopify',
    year: 2021,
    description: 'Decentralized AI infrastructure company.',
    relationship: 'Alum Investment',
  },
  {
    id: 'sundial',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2021,
    description: 'AI system that performs due diligence for private-market investors.',
    relationship: 'Alum Investment',
  },
  {
    id: 'seaplane',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2021,
    description: 'Subscription tool for creators and communities.',
    relationship: 'Alum Investment',
  },
  {
    id: 'monda',
    ...
    parent: 'shopify',
    year: 2021,
    description: 'AI chatbot that translates & customizes conversations.',
    relationship: 'Alum Investment',
  },
  {
    id: 'hurry-up',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2022,
    description: 'Empowers diverse developers.',
    relationship: 'Alum Investment',
  },
  {
    id: 'remix',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2022,
    description: 'AGI under the guidance of John Carmack.',
    relationship: 'Alum Investment',
  },
  {
    id: 'single',
  ...
  {
    id: 'stellar-live-studios',
    name: 'Stellar Live Studios',
    type: 'company',
    parent: 'shopify',
    year: 2022,
    description: 'Sports & entertainment platform.',
    relationship: 'Alum Investment',
  },
  {
    id: 'gorgias',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2022,
    description: 'Managed network services and connectivity.',
    relationship: 'Alum Investment',
  },
  {
    id: 'legacy',
    ...
    parent: 'shopify',
    year: 2022,
    description: 'Open-source tools and connection-based sales.',
    relationship: 'Alum Investment',
  },
  {
    id: 'primer',
    ...
    parent: 'shopify',
    year: 2022,
    description: 'Making kids more ambitious, creative, etc.',
    relationship: 'Alum Investment',
  },
  {
    id: 'pine-north',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2022,
    description: 'Ushering on the Bitcoin Golden Age.',
    relationship: 'Alum Investment',
  },
  {
    id: 'faire',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2023,
    description: 'Solutions for managing private assets.',
    relationship: 'Alum Investment',
  },
  {
    id: 'ten-key-labs',
    ...
    parent: 'shopify',
    year: 2023,
    description: 'Transparent OS for bringing programmable money to businesses.',
    relationship: 'Alum Investment',
  },
  {
    id: 'triggi',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2023,
    description: 'App empowering team messaging, search & building credit.',
    relationship: 'Alum Investment',
  },
  {
    id: 'sharpcult',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2023,
    description: 'Speeds up dev cycles and cuts cloud cost.',
    relationship: 'Alum Investment',
  },
  {
    id: 'rustlab',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2024,
    description: 'Infrastructure for wholesale businesses.',
    relationship: 'Alum Investment',
  },
  {
    id: 'actio',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2024,
    description: 'Developer-first security platform protecting apps.',
    relationship: 'Alum Investment',
  },
  {
    id: 'lightdash',
  ...
  },
  {
    ...
    parent: 'shopify',
    year: 2024,
    description: 'Command bar for developers.',
    relationship: 'Alum Investment',
  },
  {
    id: 'channelape',
